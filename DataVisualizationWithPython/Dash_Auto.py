...
auto_data =  pd.read_csv('DataVisualizationWithPython/automobileEDA.csv', encoding="ISO-8859-1")

#Layout Section of Dash
app.layout = html.Div(children=[html.H1('Car Automobile Components', style={'textAlign': 'center', 'color': '#503D36', 'font-size': 24}),
                                #outer division starts
                                html.Div([  html.Div(html.H2('Drive Wheels Type:', style={'margin-right': '2em'}),), # First inner divsion for  adding dropdown helper text for Selected Drive wheels
